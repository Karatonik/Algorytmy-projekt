...
public class ParentWorkersController {
    //wyszukiwarka
    ...
    public ObservableList<WorkersDataForWorkerController> data;
    //wydarzenia/projekty
    @FXML
    ...
    public ObservableList<EventDataForWorkerController> datap, dataw;
